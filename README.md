...
2. CFAR iceberg delineation, using a CFAR gamma detector with a 10<sup>-6</sup> probability of false alarm, a 49-pixel outer window size, and a 35-pixel guard window size. CFAR runs separately for the HH channel, and the HV channel.
